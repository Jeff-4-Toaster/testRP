...
// mode = 1 for encrypt (SubBytes), 0 for decrypt (InvSubBytes)
bSbox sbox3 ( in[31:24], mode, next_out[31:24] );
bSbox sbox2 ( in[23:16], mode, next_out[23:16] );
bSbox sbox1 ( in[15:8],  mode, next_out[15:8]  );
bSbox sbox0 ( in[7:0],   mode, next_out[7:0]   );
